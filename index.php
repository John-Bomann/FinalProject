			...
			<div class="container-fluid pt-5">
				<div class="row">
					...
					<div class="setting text-light mb-4" id="about">
						...
						<div class="setting text-light mb-4" id="setting">
							...
							<p class="lead">
								...
								the world are the 13 gods. At the moment, all forms of non-innate magic are divine,
								which means the gods are a big part of people’s lives.
							</p>
						</div>
					...
					<div class="col-3 text-center align-self-center">
						<img class="w-50" src="./images/d20-icon-15.png" alt="" />
					</div>
				</div>
			</div>
		</main>
